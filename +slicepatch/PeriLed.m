%{
slicepatch.PeriLed (computed) # Cut the trace around the LED stimulation
-> slicepatch.Firing
-----
...
peri_led_time:      longblob    # new time, 0 for LED starting point
...
classdef PeriLed < dj.Relvar & dj.AutoPopulate
    properties
        popRel = slicepatch.Firing & 'led_stat=1'
    end
