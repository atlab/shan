...
fig = Figure(101,'size',[80,60]); plot(bins,connMat,'ko','MarkerSize',8); hold on
...
fig = Figure(102,'size',[80,60]); plot(bins_x,connMat_x,'ko', 'MarkerSize',8); hold on
...
fig = Figure(103,'size',[80,60]); plot(bins_y,connMat_y,'ko','MarkerSize',8); hold on
