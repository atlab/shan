function t = intersectEpochs(t1,t2);
% t = intersectEpochs(t1,t2);
% t1: n by 2 matrix of start (:,1) and end (:,2) times 
% t2: m by 2 matrix of start (:,1) and end (:,2) times 
% t: returns start and end times of epochs in t1 or t2 that intersect with epochs in the other matrix
% Equivalent to A & B where A and B are boolean vectors sampled at the same frequency
